...
EMPTY_PLACEHOLDERS = {"<token>", "<ktalk_bearer_token>", "<ktalk_bot_jwt_token>", "changeme"}
...
REQUIRED_CONFIG_NAMES = (
    ...
    "KTALK_BASE_URL", "KTALK_ROOM_ID", "KTALK_BOT_USER", "KTALK_JWT_TOKEN",
    "KTALK_BEARER_TOKEN", "KTALK_HOST", "KTALK_TALK_HOST", "RECIPIENT_RESOLVER_URL",
