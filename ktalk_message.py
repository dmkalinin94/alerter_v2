...
try:
    ...
    KTALK_BASE_URL = "https://chat.ktalk.ru"; KTALK_ROOM_ID = ""; KTALK_BEARER_TOKEN = ""; KTALK_REQUEST_TIMEOUT_SECONDS = 30; KTALK_VERIFY_SSL = False; KTALK_MESSAGE_SEARCH_LIMIT = 50; KTALK_MESSAGE_SEARCH_ATTEMPTS = 3; KTALK_MESSAGE_SEARCH_DELAY_SECONDS = 1; KTALK_AGGREGATE_MESSAGE_REPEAT_COUNT = 3; KTALK_AGGREGATE_MESSAGE_REPEAT_INTERVAL_SECONDS = 60; KTALK_TALK_HOST = "https://samoletgroup.ktalk.ru"
